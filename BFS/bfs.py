...
BLUE = '#0000FF'  # Hexadecimal color code
WHITE = '#FFFFFF'  # Hexadecimal color code
GRAY = '#808080'  # Hexadecimal color code
GREEN_SCREEN =  '#00FF00' # RGB tuple
MONOKAI_PURPLE = '#AE81FF'  # Hexadecimal color code
MONOKAI_PINK = '#F92672'  # Hexadecimal color code
MONOKAI_BLUE = '#66D9EF'  # Hexadecimal color code
MONOKAI_GREEN = '#A6E22E'  # Hexadecimal color code
MONOKAI_ORANGE = '#FD971F'  # Hexadecimal color code
YELLOW = '#FFFF00'  #
class GraphNode:
...
class GraphAnimationUtils(Scene):
	...
	def highlight_node(self, graph, index, color=GREEN_SCREEN, 
		...
		surround_circle.start_angle = start_angle
		surround_circle.TAU = -TAU
...
class Transition(Scene):
	def construct(self):
		...
		representation = TextMobject("2. Header Lookup Implementation")
...
class BFSImplementation(GraphAnimationUtils):
	...
	def generate_code(self):
		...
		def_statement = TextMobject(r"$\text{def headerLookup}(G, v):$")
